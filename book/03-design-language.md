...
```mermaid
timeline
    title A continuing conversation in visual design
    Late 19th and early 20th century : Early modernism : abstraction, industry, new visual forms
    1919 to 1933 : Bauhaus : art, craft, technology, functional experimentation
    Mid 20th century : Swiss and International Typographic Style : grids, hierarchy, sans-serif type, clarity
    Late 20th century : Postmodernism : plurality, quotation, irony, disruption
    Today : Web and product design : designers combine and question these approaches
```

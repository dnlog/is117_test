...
```mermaid
flowchart LR
    A[Product: plain white T-shirt] --> B[Meaning: comfort, independence, or belonging]
    B --> C[Identity: the kind of person I can be]
    C --> D[Audience: people who recognize and value that identity]
```
